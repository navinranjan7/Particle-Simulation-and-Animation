 ...
 * Use the {@link Particle201921079Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Particle201921079Fragment extends Fragment {
    ...
    private int mLimit = 100000;

    private Draw mDraw = null;
    private boolean mAnimate;


    public Particle201921079Fragment() {
     ...
     * @return A new instance of fragment Particle201921079Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Particle201921079Fragment newInstance(String param1, String param2) {
        Particle201921079Fragment fragment = new Particle201921079Fragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        for(int i = 0; i < mParticle.length; i++)
            mParticle[i] = new Particle(Color.rgb(
                    RandGen.uniform(255), RandGen.uniform(255), RandGen.uniform(255)));
        mPQ = new MinPQ<Event>();
        for(int i = 0; i < mParticle.length; i++)
        ...
        protected void onDraw(Canvas canvas) {
            ...
            for(int i = 0; i < mParticle.length; i++){
                ...
                mmOffScreen.drawCircle((int)(mParticle[i].getRx() * mmWidth),
                        ...
                        (int) (mParticle[i].getRadius() * 1000), mmPaint);
            }
